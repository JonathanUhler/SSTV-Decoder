...
size_t find_header_sample(const WavSamples *wav_samples, const SstvMode *mode) {
    ...
    size_t leader_1_search = leader_1_sample + window_size;
    size_t leader_1_size = leader_1_search - leader_1_sample;

    size_t break_sample = round(mode->leader_time_sec * sample_rate);
    size_t break_search = break_sample + window_size;
    size_t break_size = break_search - break_sample;

    size_t leader_2_sample = round((mode->break_time_sec + mode->leader_time_sec) * sample_rate);
    size_t leader_2_search = leader_2_sample + window_size;
    size_t leader_2_size = leader_2_search - leader_2_sample;
    ...
    size_t vis_start_search = vis_start_sample + window_size;
    size_t vis_start_size = vis_start_search - vis_start_sample;
